...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2025 at 01:41 PM
...
(1, 'Carlos', 'Machutes', 'Q', 'machutes@gmail.com', '$2y$10$7gZG34oApvQ6Xw81NXOcJ.MkT1yAEUxpn1NWu.sXKNrlm6IBZrW/6', '2024-12-15 13:55:41', '2024-12-24 23:33:27'),
(2, 'Kiara', 'Cando', 'M', 'cando@gmail.com', '$2y$10$ynDm26.fkSdbRYe85zBqtuPEUaXS5nEOyMbOh/US0ApBXPTFPwBZK', '2024-12-15 14:04:11', '2024-12-24 23:34:52'),
(3, 'Chester', 'Candido', 'W', 'candido@gmail.com', '$2y$10$LGLBftl2ehVXAi3epk.C7ed4OGljPalugZ0dBGkwpfBpTs2yHuk4K', '2024-12-15 14:06:56', '2024-12-24 23:33:20'),
(5, 'Mezjra Mae', 'Bagtasos', '', 'mabs@email.com', '123', '2024-12-15 15:34:09', '2024-12-15 15:34:09'),
...
(29, 'adv', 'tst', 'a', 'adv@email.com', '$2y$10$W6S1c0MLzm..U4hE7wWgW.VZQZ3sjkV0WNgsSdwgck5c74L8FJRAm', '2024-12-23 18:32:41', '2024-12-24 23:34:56'),
...
(1, 123, 1, 4321, 5, 3, NULL),
(8, 43407133, 1, 2147483647, 5, 32, NULL);
...
INSERT INTO `student_clearance` (`student_clearance_id`, `student_id`, `approver_id`, `organization_id`, `date_approved`) VALUES
(1, 1, 1, NULL, '2024-12-15'),
(2, 1, 1, 1, '2024-12-19'),
(4, 1, 1, 2, '2024-12-19'),
(5, 1, 1, 3, '2024-12-19');
...
--
ALTER TABLE `account_roles`
  MODIFY `account_roles_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `organization_fees`
  MODIFY `organization_fee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `payment_history`
  MODIFY `payment_history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `student_clearance`
  MODIFY `student_clearance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `student_clearance`
  ADD CONSTRAINT `organization_id` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`organization_id`),
  ADD CONSTRAINT `student_clearance_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`),
  ADD CONSTRAINT `student_clearance_ibfk_2` FOREIGN KEY (`approver_id`) REFERENCES `teacher_profiles` (`teacher_id`);
COMMIT;
